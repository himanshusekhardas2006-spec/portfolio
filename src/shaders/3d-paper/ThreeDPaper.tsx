...
import threeDPaperSource from "./sources/original";
import certificateSource from "./sources/certificate";
import japaneseSource from "./sources/japanese";
import siteOfTheYearSource from "./sources/siteOfTheYear";
